...
def main():
    myMessage = "If a man is offered a fact which goes against his instincts, he will " \
...
def translateMessage(key, message, mode):
    ...
    if mode == 'decrypt':
        ...
        # just need to swap where the key and LETTERS string are used.
    ...
    for symbol in message:
        if symbol.upper() in charsA:
            ...
            # Symbol not in letters, just add it
            translated += symbol
